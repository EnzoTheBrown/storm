...
public class TopologyT4 {
	...
	public static void main(String[] args) throws Exception {
		...
		builder.setBolt("exit2", new Exit3Bolt(portOUTPUT, ipmOUTPUT), nbExecutors).fieldsGrouping("exit", new Fields("runner"));
		builder.setBolt("exit3", new ComputeBonusBolt().withWindow(new BaseWindowedBolt.Count(16), new BaseWindowedBolt.Count(15)), nbExecutors).fieldsGrouping("exit2", new Fields("tortoise"));
